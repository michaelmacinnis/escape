...
func mockcopy(data map[string]error) (err error) {
	var escape_hatch_1 func(error)
	{
		...
		escape_hatch_1 = func(v error) { // generated by escape: /home/michael/Play/go/src/escape/use/good/example_test.ego:113:30
			*p = v
...
func wrapmockcopy(data map[string]error) {
	err := mockcopy(data)
	if err != nil {
		fmt.Printf("%s\n", err.Error())
	}
