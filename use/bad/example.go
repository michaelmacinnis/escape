...
func nothingFancy() (err error) {
	var escape_hatch_1 func(error)
	{
		...
		escape_hatch_1 = func(v error) { // generated by escape: /home/michael/Play/go/src/escape/use/bad/example.ego:41:18
			*p = v
...
func nothingFancy2() (err error) {
	var escape_hatch_2 func(error)
	{
		...
		escape_hatch_2 = func(v error) { // generated by escape: /home/michael/Play/go/src/escape/use/bad/example.ego:51:18
			*p = v
...
func passToChild() (err error) {
	var escape_hatch_3 func(error)
	{
		...
		escape_hatch_3 = func(v error) { // generated by escape: /home/michael/Play/go/src/escape/use/bad/example.ego:65:18
			*p = v
...
func cannotPassToParent() (err error) {
	check := func() func(error) {
		var escape_hatch_4 func(error)
		{
			...
			escape_hatch_4 = func(v error) { // generated by escape: /home/michael/Play/go/src/escape/use/bad/example.ego:74:24
				*p = v
...
func cannotPassToParent2() (err error) {
	check := func() func(error) {
		var escape_hatch_5 func(error)
		{
			...
			escape_hatch_5 = func(v error) { // generated by escape: /home/michael/Play/go/src/escape/use/bad/example.ego:86:19
				*p = v
...
func cannotGiveCheckToAnotherGoroutine() (err error) {
	var escape_hatch_6 func(error)
	{
		...
		escape_hatch_6 = func(v error) { // generated by escape: /home/michael/Play/go/src/escape/use/bad/example.ego:96:18
			*p = v
...
func notJustForErrors() (response string) {
	var escape_hatch_7 func(string)
	{
		...
		escape_hatch_7 = func(v string) { // generated by escape: /home/michael/Play/go/src/escape/use/bad/example.ego:104:18
			*p = v
...
func additionalContext() (err error) {
	var escape_hatch_8 func(error)
	{
		...
		escape_hatch_8 = func(v error) { // generated by escape: /home/michael/Play/go/src/escape/use/bad/example.ego:112:18
			*p = v
...
func additionalContext2() (err error) {
	var escape_hatch_9 func(error)
	{
		...
		escape_hatch_9 = func(v error) { // generated by escape: /home/michael/Play/go/src/escape/use/bad/example.ego:135:27
			*p = v
